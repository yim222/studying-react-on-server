...
import ItemsTry2 from './ItemsTry2'
  ...
  render(){
    ...
    return <div className ="explain">
      ...
      <h1>I am little example app of items</h1>
        ...
        <h2>Very importants points:</h2>
      <ol>
        <li>invoke right the function in the jsx. not directly func() but inside other annonimous function</li>

        <li>When u pass value from state to local fields and vice versa u need to do it
        with clone by assign object or other way mentioned here :
        https://medium.freecodecamp.org/handling-state-in-react-four-immutable-approaches-to-consider-d1f5c00249d5 </li>
